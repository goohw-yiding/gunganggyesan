...
window.__brand = { name: '건강 계산소', emoji: '🩺', tag: '#건강계산소', c1: '#2fa8a0', c2: '#238b84' };
...
/* ===== OneSignal 웹푸시 (재방문 유도) — kcalcalc.com / appId 입력 시 자동 활성화 ===== */
window.__onesignalAppId = 'fa5c19c5-516a-4ef1-a52a-78a44476e1e5';
(function(){
